...
# --- Configuration ---
power_plant_file = '/net/fs06/d3/rzhuang/TROPOMI_world/data/power_plant_location/filtered_power_plants.csv'
city_file = '/net/fs06/d3/rzhuang/TROPOMI_world/data/worldcities.csv' # Path to your city file
