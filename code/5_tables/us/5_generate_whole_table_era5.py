...
# ───────────────────────── config ─────────────────────────
DATA_DIR   = "../data"
META_CSV   = os.path.join(DATA_DIR, "Run_600/valid_tropomi_emissions_with_qa.csv")
OUT_CSV    = os.path.join(DATA_DIR, "Run_600/processed_valid_tropomi_emissions_with_qa_updated.csv")
